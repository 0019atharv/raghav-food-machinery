...
export const initialProducts = [
  ...
  },
  {
    ...
    "category": "Packaging & Sealing",
    "categorySlug": "packaging-sealing",
    "shortDescription": "Heavy-duty electric tabletop can seamer for hermetic double seaming of tin, aluminum, and composite food/beverage cans.",
    "fullDescription": "This commercial tabletop Semi-Automatic Electric Can Seamer Machine is designed to mechanically seal lids onto tin, aluminum, PET plastic, or paperboard cans with high precision and an airtight hermetic finish. Highly popular for craft beverages, food canning laboratories, and commercial packaging facilities. Features a heavy-duty pedestal lifter and precision seaming rollers.",
    "price": "₹ 60,000",
    "priceUnit": "Ex-Factory Price",
    "capacity": "15 - 25 cans / minute (Seam time: 2-3 sec/can)",
    "power": "0.5 HP Single Phase 220V Electric Motor",
    "materialGrade": "Heavy Industrial Steel Frame & Food-Grade Hardened Seaming Rollers",
    "automationGrade": "Semi-Automatic with Lever Lifter",
    "voltage": "220V, 50 Hz Single Phase",
    "dimensions": "600 mm x 450 mm x 1100 mm",
    "weight": "65 kg approx",
    "warranty": "1 Year Commercial Warranty",
    "images": [
      "https://res.cloudinary.com/vgmmtb5k/image/upload/v1789296405/raghav-food-processing-machines/raghav-can-seamer.jpg",
      "/images/products/raghav-can-seamer.jpg"
    ],
    "specifications": [
      {
        "label": "Can Diameter Range",
        "value": "39 mm to 150 mm (Interchangeable Chucks)"
      },
      {
        "label": "Can Height Range",
        "value": "39 mm to 200 mm (Adjustable Pedestal Lifter)"
      },
      {
        "label": "Sealing Speed",
      ...
      {
        "label": "Seaming Method",
        "value": "Rotary Double Seaming Head with Dual Precision Rollers"
      },
      {
        "label": "Motor Drive",
        "value": "0.5 HP Copper-Wound High-Torque Gear Motor"
      },
      {
        "label": "Structure",
        "value": "Rigid Cast Iron / Steel Column with Floor/Bench Mount Base"
      }
    ],
    "applications": [
      "Craft Beverage, Cold Brew & Juice Canning",
      "Food Canning: Sweet Corn, Mushrooms, Fruit Slices",
      "Dry Fruit, Spices & Roasted Snack Tins",
      "Chemical, Wax & Grease Metal Container Packaging"
    ],
    "features": [
      "Airtight hermetic double seam prevents contamination and preserves freshness",
      "Adjustable pedestal lifter accommodates different can heights easily",
      "Hardened alloy steel rollers deliver uniform double seam compression with zero leaks",
